              ...
              <div class="uk-text-left info-user uk-flex uk-flex-wrap">
                  <div class="btn uk-flex">
                      <div class="uk-flex uk-flex-column uk-text-left">
                        ...
                        <span v-if="order.completed" style="display: flex; position: relative; top: -4px; color: green;">
                          <strong>Completado </strong>
                          <font-awesome-icon icon="check" style="font-size: 14px; margin: 3px" />
                          </span>
                        <p style="font-size: 13px !important; font-weight: 700" class="uk-width-1-1"><span>{{order.client}}</span></p>
                      </div>
  
                  </div>
                    <p class="uk-width-1-2"><strong>Orden: </strong><span>{{order.numberOfOrders}}</span></p>
                    <p class="uk-width-1-2"><strong>Cajas: </strong>{{order.numberOfBox}}<span></span></p>            
                    <p class="uk-width-1-1"><font-awesome-icon icon="map-marker-alt"/>&nbsp;<span>{{order.address}}</span></p>
              </div>
              <div class="uk-flex uk-flex-column" style="min-width: 90px; margin-left: 7px; align-items: flex-end">
                    <div class="uk-flex uk-flex-column" @click="scan(order)" style="align-items: center;">
