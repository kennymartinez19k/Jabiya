    ...
    <div>
      ...
      >
        <div class="uk-text-left info-user">
          ...
          <p>
            <strong>No. de Orden(es): </strong>{{ load.numberOfOrden
            }}<span>2</span>
          </p>
          <p>
